...
class LSTM(BaseModel):
    def __init__(self, parameters):
        ...
        self.model = tf.keras.models.Sequential([
            tf.keras.layers.LSTM(256, input_shape=[parameters['n_steps_in'], parameters['n_features']]),
    ...
    def save_model(self, save_dir_model):
        ...
        save_file = os.path.join(dir_cp, os.path.basename(save_dir_model).split('.')[0] + '.ckpt')
