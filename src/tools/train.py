...
def train(args):
    ...
    save_config = True
    if (save_config):
        saved_config_path = os.path.join(args.saved_runs_folder, train_id, "train_config.yaml")
    ...
    for station_data_path in glob.glob(os.path.join(config['dataset']['train']['args']['path'], "input/*")):
        ...
        for model_name in config['models']:
            ...
            saved_model_path = os.path.join(args.saved_runs_folder, train_id, "models", model_name, station_name + ".json")
